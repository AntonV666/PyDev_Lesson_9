...
washing_gel = Household_chemicals(name="Гель", category="Средства для стирки", brand="Tide", price=400)
...
cart = ShoppingCart()
cart.add_item(laptop, 1) # , customer, admin
cart.add_item(tshirt, 3)
cart.add_item(washing_gel, 2)
